...
4. **Style consistency** — reference existing refactored modules (e.g. model_interpretation/, comparison_with_SOTA/) to maintain project-level uniformity
...
10. **New naming: "vformer"** — refactored training code uses "vformer" as the project keyword (replacing "pivfinder")
